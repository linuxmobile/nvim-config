...
vim.api.nvim_command([[
  ...
  exe "hi NeoTreeGitConflict guifg=".g:terminal_color_8
  ...
  hi PmenuSbar guibg=background guifg=#242424
  ...
  hi InclineNormal guibg=#404040
  hi InclineNormal guifg=#e8e3e3
  hi InclineNormalNC guibg=#282828
  hi InclineNormalNC guifg=#e8e3e3
]])
